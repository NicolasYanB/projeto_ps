...
if __name__ == "__main__":
    ...
    # Substituindo a antiga opção 9 pelos dois novos comandos:
    menu.registrar("9", LoginCommand(sessao))
    menu.registrar("10", CadastroCommand(sessao))
    ...
    while True:
        ...
        print("9 - Fazer Login | 10 - Criar Nova Conta | 0 - Sair") # Menu atualizado aqui
        print("="*50)
